...
class OwnerController {
    ...
    public OwnerController(OwnerRepository clinicService, CommandGateway commandGateway) {
    ...
    public String processCreationForm(@Valid Owner owner, BindingResult result) {
        if (result.hasErrors()) {
            ...
            owner = commandGateway.sendAndWait(new CreateOwnerCommand(owner));
    ...
    public String processUpdateOwnerForm(@Valid Owner owner, BindingResult result, @PathVariable("ownerId") int ownerId) {
        if (result.hasErrors()) {
            ...
            this.commandGateway.sendAndWait(new UpdateOwnerCommand(owner, ownerId));
