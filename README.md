# Spring PetClinic Sample Application [![Build Status](https://travis-ci.org/sleroy/spring-cqrs-arch.png?branch=master)](https://travis-ci.org/sleroy/spring-cqrs-arch/)

The project has been rewritten to use the light CQRS framework [CQRS](https://github.com/sleroy/spring-cqrs-arch).
